...
import static com.openpojo.dns.config.DnsConfigReaderFactory.getConfigReader;
...
public class DnsConfigReaderFactoryTest {
  ...
  public void shouldReturnNoOpDnsConfigReaderWhenConfigFileNotAvailable() {
    assertThat(getConfigReader(), instanceOf(NoOpDnsConfigReader.class));
  }

  @Test
  public void shouldGet() {
    System.setProperty(CONFIG_FILE_ENV_VARIABLE, DNS_CONTROL_CONFIG);
    assertThat(getConfigReader(), instanceOf(FileDnsConfigReader.class));
  }
}
